...
#include "supersonic/utils/atomic/atomic_std.h"
#else
#include <stddef.h>
#include <stdint.h>
...
#include "supersonic/utils/atomic/atomic_internal.h"
#include "supersonic/utils/atomic/locking.h"

#if defined(THREAD_SANITIZER)
#include "supersonic/utils/atomic/tsan.h"
#elif defined(__GNUC__) && (defined(__i386) || defined(__x86_64__))
#include "supersonic/utils/atomic/x86-gcc.h"
#else
struct clobber {
