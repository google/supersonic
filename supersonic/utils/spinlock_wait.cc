...
#include "supersonic/utils/spinlock_wait.h"

// forward declaration for use by spinlock_*-inl.h
namespace base { namespace subtle { static int SuggestedDelayNS(int loop); }}

#if defined(OS_WINDOWS)
#include "supersonic/utils/spinlock_win32-inl.h"
#elif defined(OS_LINUX)
#include "supersonic/utils/spinlock_linux-inl.h"
#else
#include "supersonic/utils/spinlock_posix-inl.h"
#endif
