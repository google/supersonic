...
#include "supersonic/utils/demangle.h"  // For Cursor::GetDebugDescription().

namespace supersonic {

void BasicCursor::AppendDebugDescription(string* const target) const {
...
const string& BasicCursor::LazilyGetDebugDescription() const {
...
string BasicCursor::DebugDescription() const {
